...
//bytecode + vm changes in chunk.h
OP_Method, 
OP_GET_LOCAL_LONG,
OP_SET_LOCAL_LONG, 

//in vm.c reads 2-byte slot index
...
//Updates local value without popping
case OP_SET_LOCAL: {
...
//Debug | Disassembler Changes in debug.c
